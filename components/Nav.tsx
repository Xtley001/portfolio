...
export default function Nav({ githubUrl = 'https://github.com/Xtley001', logoText = 'XTLEY001' }: { githubUrl?: string; logoText?: string }) {
  ...
  // Admin link — only visible in nav, no label text so it stays discreet
    ...
    <>
      ...
      >
        ...
        <div className="hidden-mobile" style={{ gap: '32px', alignItems: 'center' }}>
          ...
          <a href={adminHref}
            style={{ fontFamily: 'var(--font-dm-mono)', fontSize: '11px', color: 'var(--text-faint)', letterSpacing: '0.1em', padding: '4px 8px', transition: 'color 0.2s' }}
